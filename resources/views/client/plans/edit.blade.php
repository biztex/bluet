        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    @endif
                    <form id="form1" action="/client/plans/update/{{ $plans->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" name="kind">
                                  <option value="0" @if(old('kind',$plans->kind)==0) selected  @endif>アクティビティ体験プラン</option>
                                  <option value="1" @if(old('kind',$plans->kind)==1) selected  @endif>日帰りツアー</option>
                                  <option value="2" @if(old('kind',$plans->kind)==2) selected  @endif>宿泊付きツアー</option>
                                  <option value="3" @if(old('kind',$plans->kind)==3) selected  @endif>宿泊プラン</option>
                                  <option value="4" @if(old('kind',$plans->kind)==4) selected  @endif>カスタマイズツアー</option>
                                  <option value="5" @if(old('kind',$plans->kind)==5) selected  @endif>貸切交通手配（タクシー・バス）</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="name" value="{{ old('name',$plans->name) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> {{ __('ツアーコード') }}</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="tour_code" value="{{ old('name',$plans->tour_code) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> キャッチコピー</label>
                            <div class="col-md-8">
                                <textarea id="" type="textarea" class="form-control" name="catchphrase" rows="5" placeholder="※最大300文字まで">{{ old('catchphrase',$plans->catchphrase) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> プラン説明文</label>
                            <div class="col-md-8">
                                <textarea id="" type="textarea" class="form-control" name="description" rows="15" placeholder="※最大1200文字まで">{{ old('description',$plans->description) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> 開催期間</label>
                            <div class="col-md-2">
                                <input id="" type="date" class="form-control" name="start_day" value="{{ old('start_day',$plans->start_day) }}">
                            </div>
                            <label class="col-md-1 col-form-label text-md-center">〜</label>
                            <div class="col-md-2">
                                <input id="" type="date" class="form-control" name="end_day" value="{{ old('end_day',$plans->end_day) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row ml-5 month-flag">
                            ...
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="repetition_day" value="{{ old('repetition_day',$plans->repetition_day) }}">
                            </div>
                            <label class="col-md-1 col-form-label text-md-right">日に設定</label>
                        </div>
			<input type="hidden" name="holiday_selected" value="1">
			<input type="hidden" name="holiday_nonselected" value="1">
			<input type="hidden" name="is_autoextend" value="0">
                        <hr />
                        @foreach ($plans->activities as $activity)
                        <div class="activity-section-{{ $loop->index + 1 }}">
                            <div class="form-group row mt-3">
                                <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> 体験時間 ({{ $loop->index + 1 }})</label>
                                @if ($loop->last && $loop->count != 1)
                                <div class="col-md-3">
                                    <div type="" class="btn btn-default" name='delete-activity-{{ $loop->index + 1 }}' value=''>
                                        <i class="fas fa-fw fa-window-close"></i> この体験時間を削除
                                    </div>
                                </div>
                                @elseif (!$loop->first && $loop->count != 1) 
                                <div class="col-md-3">
                                    <div type="" class="btn btn-default" name='delete-activity-{{ $loop->index + 1 }}' style="display: none;" value=''>
                                        <i class="fas fa-fw fa-window-close"></i> この体験時間を削除
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="" type="text" class="form-control" name="activity_name{{ $loop->index + 1 }}" value="{{ old('activity_name', $activity->name) }}" placeholder="※最大30文字まで">
                                </div>
                            </div>
                            <div class="form-group row mt-5">
                                <label class="col-md-2 col-form-label text-md-right" style="padding: 0 0 3px 0;">【時間】</label>
                                <label class="radio-inline">
                                  <input class="ml-5" type="radio" name="activity_is_overday{{ $loop->index + 1 }}" value="0" @if ($activity->is_overday == 0) checked @endif> <span> 日をまたがない</span>
                                </label>
                                <label class="checkbox-inline">
                                  <input class="ml-5" type="radio" name="activity_is_overday{{ $loop->index + 1 }}" value="1" @if ($activity->is_overday == 1) checked @endif> <span> 日をまたいで設定する</span>
                                </label>
                            </div>
                            <div class="form-group row ml-5">
                                <div class="col-md-1 ml-5">
                                    <select class="form-control ml-5" name="activity_start_hour{{ $loop->index + 1 }}">
                                      <option value="00" @if(old('activity_start_hour',$activity->start_hour)=='00') selected  @endif>00</option>
                                      <option value="01" @if(old('activity_start_hour',$activity->start_hour)=='01') selected  @endif>01</option>
                                      <option value="02" @if(old('activity_start_hour',$activity->start_hour)=='02') selected  @endif>02</option>
                                      <option value="03" @if(old('activity_start_hour',$activity->start_hour)=='03') selected  @endif>03</option>
                                      <option value="04" @if(old('activity_start_hour',$activity->start_hour)=='04') selected  @endif>04</option>
                                      <option value="05" @if(old('activity_start_hour',$activity->start_hour)=='05') selected  @endif>05</option>
                                      <option value="06" @if(old('activity_start_hour',$activity->start_hour)=='06') selected  @endif>06</option>
                                      <option value="07" @if(old('activity_start_hour',$activity->start_hour)=='07') selected  @endif>07</option>
                                      <option value="08" @if(old('activity_start_hour',$activity->start_hour)=='08') selected  @endif>08</option>
                                      <option value="09" @if(old('activity_start_hour',$activity->start_hour)=='09') selected  @endif>09</option>
                                      <option value="10" @if(old('activity_start_hour',$activity->start_hour)=='10') selected  @endif>10</option>
                                      <option value="11" @if(old('activity_start_hour',$activity->start_hour)=='11') selected  @endif>11</option>
                                      <option value="12" @if(old('activity_start_hour',$activity->start_hour)=='12') selected  @endif>12</option>
                                      <option value="13" @if(old('activity_start_hour',$activity->start_hour)=='13') selected  @endif>13</option>
                                      <option value="14" @if(old('activity_start_hour',$activity->start_hour)=='14') selected  @endif>14</option>
                                      <option value="15" @if(old('activity_start_hour',$activity->start_hour)=='15') selected  @endif>15</option>
                                      <option value="16" @if(old('activity_start_hour',$activity->start_hour)=='16') selected  @endif>16</option>
                                      <option value="17" @if(old('activity_start_hour',$activity->start_hour)=='17') selected  @endif>17</option>
                                      <option value="18" @if(old('activity_start_hour',$activity->start_hour)=='18') selected  @endif>18</option>
                                      <option value="19" @if(old('activity_start_hour',$activity->start_hour)=='19') selected  @endif>19</option>
                                      <option value="20" @if(old('activity_start_hour',$activity->start_hour)=='20') selected  @endif>20</option>
                                      <option value="21" @if(old('activity_start_hour',$activity->start_hour)=='21') selected  @endif>21</option>
                                      <option value="22" @if(old('activity_start_hour',$activity->start_hour)=='22') selected  @endif>22</option>
                                      <option value="23" @if(old('activity_start_hour',$activity->start_hour)=='23') selected  @endif>23</option>
                                    </select>
                                </div>
                                <div class="col-md-1 ml-5">
                                    <select class="form-control" name="activity_start_minute{{ $loop->index + 1 }}">
                                      <option value="00" @if(old('activity_start_minute',$activity->start_minute)=='00') selected  @endif>00</option>
                                      <option value="05" @if(old('activity_start_minute',$activity->start_minute)=='05') selected  @endif>05</option>
                                      <option value="10" @if(old('activity_start_minute',$activity->start_minute)=='10') selected  @endif>10</option>
                                      <option value="15" @if(old('activity_start_minute',$activity->start_minute)=='15') selected  @endif>15</option>
                                      <option value="20" @if(old('activity_start_minute',$activity->start_minute)=='20') selected  @endif>20</option>
                                      <option value="25" @if(old('activity_start_minute',$activity->start_minute)=='25') selected  @endif>25</option>
                                      <option value="30" @if(old('activity_start_minute',$activity->start_minute)=='30') selected  @endif>30</option>
                                      <option value="35" @if(old('activity_start_minute',$activity->start_minute)=='35') selected  @endif>35</option>
                                      <option value="40" @if(old('activity_start_minute',$activity->start_minute)=='40') selected  @endif>40</option>
                                      <option value="45" @if(old('activity_start_minute',$activity->start_minute)=='45') selected  @endif>45</option>
                                      <option value="50" @if(old('activity_start_minute',$activity->start_minute)=='50') selected  @endif>50</option>
                                      <option value="55" @if(old('activity_start_minute',$activity->start_minute)=='55') selected  @endif>55</option>
                                    </select>
                                </div>
                                <label class="col-md-1 col-form-label text-md-center">〜</label>
                                <div class="col-md-1 overday-section">
                                    <select class="form-control" name="activity_days_after{{ $loop->index + 1 }}">
                                      <option value="00" @if(old('activity_days_after',$activity->days_after)=='00') selected  @endif>00</option>
                                      <option value="01" @if(old('activity_days_after',$activity->days_after)=='01') selected  @endif>01</option>
                                      <option value="02" @if(old('activity_days_after',$activity->days_after)=='02') selected  @endif>02</option>
                                      <option value="03" @if(old('activity_days_after',$activity->days_after)=='03') selected  @endif>03</option>
                                      <option value="04" @if(old('activity_days_after',$activity->days_after)=='04') selected  @endif>04</option>
                                      <option value="05" @if(old('activity_days_after',$activity->days_after)=='05') selected  @endif>05</option>
                                      <option value="06" @if(old('activity_days_after',$activity->days_after)=='06') selected  @endif>06</option>
                                    </select>
                                </div>
                                <label class="col-md-1 col-form-label text-md-center overday-section">日後の</label>
                                <div class="col-md-1">
                                    <select class="form-control" name="activity_end_hour{{ $loop->index + 1 }}">
                                      <option value="00" @if(old('activity_end_hour',$activity->end_hour)=='00') selected  @endif>00</option>
                                      <option value="01" @if(old('activity_end_hour',$activity->end_hour)=='01') selected  @endif>01</option>
                                      <option value="02" @if(old('activity_end_hour',$activity->end_hour)=='02') selected  @endif>02</option>
                                      <option value="03" @if(old('activity_end_hour',$activity->end_hour)=='03') selected  @endif>03</option>
                                      <option value="04" @if(old('activity_end_hour',$activity->end_hour)=='04') selected  @endif>04</option>
                                      <option value="05" @if(old('activity_end_hour',$activity->end_hour)=='05') selected  @endif>05</option>
                                      <option value="06" @if(old('activity_end_hour',$activity->end_hour)=='06') selected  @endif>06</option>
                                      <option value="07" @if(old('activity_end_hour',$activity->end_hour)=='07') selected  @endif>07</option>
                                      <option value="08" @if(old('activity_end_hour',$activity->end_hour)=='08') selected  @endif>08</option>
                                      <option value="09" @if(old('activity_end_hour',$activity->end_hour)=='09') selected  @endif>09</option>
                                      <option value="10" @if(old('activity_end_hour',$activity->end_hour)=='10') selected  @endif>10</option>
                                      <option value="11" @if(old('activity_end_hour',$activity->end_hour)=='11') selected  @endif>11</option>
                                      <option value="12" @if(old('activity_end_hour',$activity->end_hour)=='12') selected  @endif>12</option>
                                      <option value="13" @if(old('activity_end_hour',$activity->end_hour)=='13') selected  @endif>13</option>
                                      <option value="14" @if(old('activity_end_hour',$activity->end_hour)=='14') selected  @endif>14</option>
                                      <option value="15" @if(old('activity_end_hour',$activity->end_hour)=='15') selected  @endif>15</option>
                                      <option value="16" @if(old('activity_end_hour',$activity->end_hour)=='16') selected  @endif>16</option>
                                      <option value="17" @if(old('activity_end_hour',$activity->end_hour)=='17') selected  @endif>17</option>
                                      <option value="18" @if(old('activity_end_hour',$activity->end_hour)=='18') selected  @endif>18</option>
                                      <option value="19" @if(old('activity_end_hour',$activity->end_hour)=='19') selected  @endif>19</option>
                                      <option value="20" @if(old('activity_end_hour',$activity->end_hour)=='20') selected  @endif>20</option>
                                      <option value="21" @if(old('activity_end_hour',$activity->end_hour)=='21') selected  @endif>21</option>
                                      <option value="22" @if(old('activity_end_hour',$activity->end_hour)=='22') selected  @endif>22</option>
                                      <option value="23" @if(old('activity_end_hour',$activity->end_hour)=='23') selected  @endif>23</option>
                                    </select>
                                </div>
                                <div class="col-md-1">
                                    <select class="form-control" name="activity_end_minute{{ $loop->index + 1 }}">
                                      <option value="00" @if(old('activity_end_minute',$activity->end_minute)=='00') selected  @endif>00</option>
                                      <option value="05" @if(old('activity_end_minute',$activity->end_minute)=='05') selected  @endif>05</option>
                                      <option value="10" @if(old('activity_end_minute',$activity->end_minute)=='10') selected  @endif>10</option>
                                      <option value="15" @if(old('activity_end_minute',$activity->end_minute)=='15') selected  @endif>15</option>
                                      <option value="20" @if(old('activity_end_minute',$activity->end_minute)=='20') selected  @endif>20</option>
                                      <option value="25" @if(old('activity_end_minute',$activity->end_minute)=='25') selected  @endif>25</option>
                                      <option value="30" @if(old('activity_end_minute',$activity->end_minute)=='30') selected  @endif>30</option>
                                      <option value="35" @if(old('activity_end_minute',$activity->end_minute)=='35') selected  @endif>35</option>
                                      <option value="40" @if(old('activity_end_minute',$activity->end_minute)=='40') selected  @endif>40</option>
                                      <option value="45" @if(old('activity_end_minute',$activity->end_minute)=='45') selected  @endif>45</option>
                                      <option value="50" @if(old('activity_end_minute',$activity->end_minute)=='50') selected  @endif>50</option>
                                      <option value="55" @if(old('activity_end_minute',$activity->end_minute)=='55') selected  @endif>55</option>
                                    </select>
                                </div>
                            </div>
                            <div class="form-group row mt-5">
                                ...
                                <label class="radio-inline">
                                  <input class="ml-5" type="radio" name="activity_period_flag{{ $loop->index + 1 }}" value="0" @if ($activity->period_flag == 0) checked @endif> <span> 開催期間と同じ</span>
                                </label>
                                <label class="checkbox-inline">
                                  <input class="ml-5" type="radio" name="activity_period_flag{{ $loop->index + 1 }}" value="1" @if ($activity->period_flag == 1) checked @endif> <span> 開催期間とは別に指定する</span>
                                </label>
                            </div>
                            <div class="form-group row ml-5 activity_day_section">
                                <div class="col-md-2 ml-5">
                                    <input id="" type="date" class="form-control ml-5" name="activity_start_day{{ $loop->index + 1 }}" value="{{ old('activity_start_day',$activity->start_day) }}">
                                </div>
                                <label class="ml-5 col-md-1 col-form-label text-md-center">〜</label>
                                <div class="col-md-2">
                                    <input id="" type="date" class="form-control" name="activity_end_day{{ $loop->index + 1 }}" value="{{ old('activity_end_day',$activity->end_day) }}">
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-md-6">
                        ...
                        <div class="after-activity-section-{{ $loop->index + 1 }}"></div>
                        @endforeach
                        ...
                        <div class="form-group row mt-4">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> 所要時間</label>
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="time_hour" value="{{ old('time_hour',$plans->time_hour) }}">
                            </div>
                            <label class="col-md-1 col-form-label text-md-left">時間</label>
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="time_minute" value="{{ old('time_minute',$plans->time_minute) }}">
                            </div>
                            <label class="col-md-1 col-form-label text-md-left">分</label>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">対象年齢</label>
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="age_from" value="{{ old('age_from',$plans->age_from) }}">
                            </div>
                            <label class="col-md-1 col-form-label text-md-left">歳〜</label>
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="age_to" value="{{ old('age_to',$plans->age_to) }}">
                            </div>
                            <label class="col-md-1 col-form-label text-md-left">歳まで</label>
                        </div>
                        <hr />
                        <div class="form-group row">
			    ...
			    @if ($plans->genre->category)
                            <input type="hidden" id="genre_id" data-genrecategory="{{ $plans->genre->category }}" value="{{ $plans->genre->id }}">
			    @endif
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <label class="radio-inline">
                              <input class="ml-5" type="radio" name="res_type" value="0" @if ($plans->res_type == 0) checked @endif> <span> 即時</span>
                            </label>
                            <label class="checkbox-inline">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="res_before_day" value="{{ old('res_before_day',$plans->res_before_day) }}">
                            </div>
                            <div class="col-md-2">
				  ...
				  -->
                        ...
                        <div class="form-group row res-section1 mt-4">
                            <label class="col-md-2 col-form-label text-md-right" style="padding: 0 0 3px 0;">【即時予約】</label>
			    <!--
                            <label class="radio-inline">
                              <input class="ml-5" type="radio" name="res_end_flag" value="0" @if ($plans->res_end_flag == 0) checked @endif> <span> 前日まで受付する</span>
                            </label>
                            <label class="checkbox-inline">
                              <input class="ml-5" type="radio" name="res_end_flag" value="1" @if ($plans->res_end_flag == 1) checked @endif> <span> 前日以前を指定する</span>
                            </label>
			    -->
			    <input type="hidden" name="res_end_flag" value="1">
                        </div>
                        <div class="form-group row ml-5 res-section2">
                            <div class="col-md-1 ml-5">
                                <input id="" type="text" class="form-control" name="res_end_day" value="{{ old('res_end_day',$plans->res_end_day) }}">
                            </div>
                            <div class="col-md-2">
				  ...
				  -->
                        ...
                        <div class="form-group row mt-4">
                            <label class="col-md-2 col-form-label text-md-right" style="padding: 0 0 3px 0;">【リクエスト予約】</label>
                        </div>
                        <div class="form-group row ml-5 req-section">
                            <div class="col-md-1 ml-5">
                                <input id="" type="text" class="form-control" name="req_before_day" value="{{ old('req_before_day',$plans->req_before_day) }}">
                            </div>
                            <div class="col-md-2">
				  ...
				  -->
                        ...
                        <hr />
                        <div class="form-group row res-limit-section mt-4">
                            <label class="col-md-2 col-form-label text-md-right" style="padding: 0 0 3px 0;"><span class="badge badge-danger">必須</span> 即時予約受付制限</label>
                            <label class="radio-inline">
                              <input class="ml-5" type="radio" name="res_limit_flag" value="0" @if ($plans->res_limit_flag == 0) checked @endif> <span> 予約人数で管理</span>
                            </label>
                            <label class="checkbox-inline">
                              <input class="ml-5" type="radio" name="res_limit_flag" value="1" @if ($plans->res_limit_flag == 1) checked @endif> <span> 予約件数で管理</span>
                            </label>
                        </div>
                        <div class="form-group row ml-5 res-limit-section">
                            <label class="col-md-2 col-form-label text-md-right"></label>
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="res_limit_number" value="{{ old('res_limit_number',$plans->res_limit_number) }}">
                            </div>
                            <label class="col-md-3 col-form-label text-md-left"><span class="switch-limit-number">人</span></label>
                        </div>
                        <div class="form-group row mt-4">
                            <label class="col-md-2 col-form-label text-md-right">1予約あたり最小人数	</label>
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="min_number" value="{{ old('min_number',$plans->min_number) }}">
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-1">
                                <input id="" type="text" class="form-control" name="max_number" value="{{ old('max_number',$plans->max_number) }}">
                            </div>
                            <label class="col-md-3 col-form-label text-md-left">人</label>
                        </div>
                        <div class="form-group row mt-5 bg-dark">
                        ...
                        <div class="form-group row">
                            ...
                            <label class="radio-inline">
                              <input class="ml-5 payment-method-group" type="checkbox" name="spot" value="1" @if ($plans->spot == 1) checked @endif> <span> 現地払い</span>
                            </label>
                            <label class="checkbox-inline">
                              <input class="ml-5 payment-method-group" type="checkbox" name="prepay" value="1" @if ($plans->prepay == 1) checked @endif> <span> 事前払い</span>
                            </label>
                            <label class="checkbox-inline">
                              <input class="ml-5 payment-method-group" type="checkbox" name="cvs" value="1" @if ($plans->cvs == 1) checked @endif> <span> 事前コンビニ決済</span>
                            </label>
                            <label class="checkbox-inline">
                              <input class="ml-5 payment-method-group" type="checkbox" name="card" value="1" @if ($plans->card == 1) checked @endif> <span> 事前クレジットカード決済</span>
                            </label>
                        </div>
                        ...
                        <div class="form-group row card_section">
                            ...
                            <div class="col-md-4">
                                <input id="" type="text" class="form-control" name="etc_card_name" value="{{ old('etc_card_name',$plans->etc_card_name) }}" placeholder="※最大50文字まで">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"> 支払方法の補足・詳細</label>
                            <div class="col-md-6">
                                <textarea id="" type="textarea" class="form-control" name="payment_comment" rows="2" placeholder="※最大200文字まで">{{ old('payment_comment',$plans->payment_comment) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-5 bg-dark">
					...
					@endforeach
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 discount-price">
                                    <input id="" type="text" class="form-control" name="price_before_price{{ $loop->index + 1 }}" value="{{ old('price_before_price',$price->before_price) }}">
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <input id="" type="text" class="form-control" name="price_price{{ $loop->index + 1 }}" value="{{ old('price_price',$price->price) }}">
                                </div>
                            ...
                            <div class="form-group row ml-5 week-price-section-{{ $loop->index + 1 }}">
                                <div class="col-md-1 ml-4">
                                    <input id="" type="text" class="form-control" name="price_monday{{ $loop->index + 1 }}" value="{{ old('price_monday',$price->monday) }}">
                                </div>
                                <div class="col-md-1 ml-4">
                                    <input id="" type="text" class="form-control" name="price_tuesday{{ $loop->index + 1 }}" value="{{ old('price_tuesday',$price->tuesday) }}">
                                </div>
                                <div class="col-md-1 ml-4">
                                    <input id="" type="text" class="form-control" name="price_wednesday{{ $loop->index + 1 }}" value="{{ old('price_wednesday',$price->wednesday) }}">
                                </div>
                                <div class="col-md-1 ml-4">
                                    <input id="" type="text" class="form-control" name="price_thursday{{ $loop->index + 1 }}" value="{{ old('price_thursday',$price->thursday) }}">
                                </div>
                                <div class="col-md-1 ml-4">
                                    <input id="" type="text" class="form-control" name="price_friday{{ $loop->index + 1 }}" value="{{ old('price_friday',$price->friday) }}">
                                </div>
                                <div class="col-md-1 ml-4">
                                    <input id="" type="text" class="form-control" name="price_saturday{{ $loop->index + 1 }}" value="{{ old('price_saturday',$price->saturday) }}">
                                </div>
                                <div class="col-md-1 ml-4">
                                    <input id="" type="text" class="form-control" name="price_sunday{{ $loop->index + 1 }}" value="{{ old('price_sunday',$price->sunday) }}">
                                </div>
                                <div class="col-md-1 ml-4">
                                    <input id="" type="text" class="form-control" name="price_holiday{{ $loop->index + 1 }}" value="{{ old('price_holiday',$price->holiday) }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row mt-5">
                            ...
                            <div class="col-md-6">
                                <textarea id="" type="textarea" class="form-control" name="included_item" rows="2" placeholder="※最大100文字まで">{{ old('included_item',$plans->included_item) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-5 bg-dark">
                            <label class="col-md-10 col-form-label text-md-left"><span class="h5"><i class="fas fa-fw fa-cog"></i> 体験場所設定</span></label>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> 体験場所名</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="place_name" value="{{ old('place_name',$plans->place_name) }}" placeholder="※最大120文字まで">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"> 郵便番号</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="place_postalcode" value="{{ old('place_postalcode',$plans->place_postalcode) }}" onKeyUp="AjaxZip3.zip2addr(this,'','place_prefecture','place_address');" placeholder="自動で住所検索します（ハイフンありなし可）">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <select class="form-control" name="place_prefecture">
                                    ...
                                    <option value="北海道" @if(old('place_prefecture',$plans->place_prefecture)=='北海道') selected @endif>北海道</option>
                                    <option value="青森県" @if(old('place_prefecture',$plans->place_prefecture)=='青森県') selected @endif>青森県</option>
                                    <option value="岩手県" @if(old('place_prefecture',$plans->place_prefecture)=='岩手県') selected @endif>岩手県</option>
                                    <option value="宮城県" @if(old('place_prefecture',$plans->place_prefecture)=='宮城県') selected @endif>宮城県</option>
                                    <option value="秋田県" @if(old('place_prefecture',$plans->place_prefecture)=='秋田県') selected @endif>秋田県</option>
                                    <option value="山形県" @if(old('place_prefecture',$plans->place_prefecture)=='山形県') selected @endif>山形県</option>
                                    <option value="福島県" @if(old('place_prefecture',$plans->place_prefecture)=='福島県') selected @endif>福島県</option>
                                    <option value="茨城県" @if(old('place_prefecture',$plans->place_prefecture)=='茨城県') selected @endif>茨城県</option>
                                    <option value="栃木県" @if(old('place_prefecture',$plans->place_prefecture)=='栃木県') selected @endif>栃木県</option>
                                    <option value="群馬県" @if(old('place_prefecture',$plans->place_prefecture)=='群馬県') selected @endif>群馬県</option>
                                    <option value="埼玉県" @if(old('place_prefecture',$plans->place_prefecture)=='埼玉県') selected @endif>埼玉県</option>
                                    <option value="千葉県" @if(old('place_prefecture',$plans->place_prefecture)=='千葉県') selected @endif>千葉県</option>
                                    <option value="東京都" @if(old('place_prefecture',$plans->place_prefecture)=='東京都') selected @endif>東京都</option>
                                    <option value="神奈川県" @if(old('place_prefecture',$plans->place_prefecture)=='神奈川県') selected @endif>神奈川県</option>
                                    <option value="新潟県" @if(old('place_prefecture',$plans->place_prefecture)=='新潟県') selected @endif>新潟県</option>
                                    <option value="富山県" @if(old('place_prefecture',$plans->place_prefecture)=='富山県') selected @endif>富山県</option>
                                    <option value="石川県" @if(old('place_prefecture',$plans->place_prefecture)=='石川県') selected @endif>石川県</option>
                                    <option value="福井県" @if(old('place_prefecture',$plans->place_prefecture)=='福井県') selected @endif>福井県</option>
                                    <option value="山梨県" @if(old('place_prefecture',$plans->place_prefecture)=='山梨県') selected @endif>山梨県</option>
                                    <option value="長野県" @if(old('place_prefecture',$plans->place_prefecture)=='長野県') selected @endif>長野県</option>
                                    <option value="岐阜県" @if(old('place_prefecture',$plans->place_prefecture)=='岐阜県') selected @endif>岐阜県</option>
                                    <option value="静岡県" @if(old('place_prefecture',$plans->place_prefecture)=='静岡県') selected @endif>静岡県</option>
                                    <option value="愛知県" @if(old('place_prefecture',$plans->place_prefecture)=='愛知県') selected @endif>愛知県</option>
                                    <option value="三重県" @if(old('place_prefecture',$plans->place_prefecture)=='三重県') selected @endif>三重県</option>
                                    <option value="滋賀県" @if(old('place_prefecture',$plans->place_prefecture)=='滋賀県') selected @endif>滋賀県</option>
                                    <option value="京都府" @if(old('place_prefecture',$plans->place_prefecture)=='京都府') selected @endif>京都府</option>
                                    <option value="大阪府" @if(old('place_prefecture',$plans->place_prefecture)=='大阪府') selected @endif>大阪府</option>
                                    <option value="兵庫県" @if(old('place_prefecture',$plans->place_prefecture)=='兵庫県') selected @endif>兵庫県</option>
                                    <option value="奈良県" @if(old('place_prefecture',$plans->place_prefecture)=='奈良県') selected @endif>奈良県</option>
                                    <option value="和歌山県" @if(old('place_prefecture',$plans->place_prefecture)=='和歌山県') selected @endif>和歌山県</option>
                                    <option value="鳥取県" @if(old('place_prefecture',$plans->place_prefecture)=='鳥取県') selected @endif>鳥取県</option>
                                    <option value="島根県" @if(old('place_prefecture',$plans->place_prefecture)=='島根県') selected @endif>島根県</option>
                                    <option value="岡山県" @if(old('place_prefecture',$plans->place_prefecture)=='岡山県') selected @endif>岡山県</option>
                                    <option value="広島県" @if(old('place_prefecture',$plans->place_prefecture)=='広島県') selected @endif>広島県</option>
                                    <option value="山口県" @if(old('place_prefecture',$plans->place_prefecture)=='山口県') selected @endif>山口県</option>
                                    <option value="徳島県" @if(old('place_prefecture',$plans->place_prefecture)=='徳島県') selected @endif>徳島県</option>
                                    <option value="香川県" @if(old('place_prefecture',$plans->place_prefecture)=='香川県') selected @endif>香川県</option>
                                    <option value="愛媛県" @if(old('place_prefecture',$plans->place_prefecture)=='愛媛県') selected @endif>愛媛県</option>
                                    <option value="高知県" @if(old('place_prefecture',$plans->place_prefecture)=='高知県') selected @endif>高知県</option>
                                    <option value="福岡県" @if(old('place_prefecture',$plans->place_prefecture)=='福岡県') selected @endif>福岡県</option>
                                    <option value="佐賀県" @if(old('place_prefecture',$plans->place_prefecture)=='佐賀県') selected @endif>佐賀県</option>
                                    <option value="長崎県" @if(old('place_prefecture',$plans->place_prefecture)=='長崎県') selected @endif>長崎県</option>
                                    <option value="熊本県" @if(old('place_prefecture',$plans->place_prefecture)=='熊本県') selected @endif>熊本県</option>
                                    <option value="大分県" @if(old('place_prefecture',$plans->place_prefecture)=='大分県') selected @endif>大分県</option>
                                    <option value="宮崎県" @if(old('place_prefecture',$plans->place_prefecture)=='宮崎県') selected @endif>宮崎県</option>
                                    <option value="鹿児島県" @if(old('place_prefecture',$plans->place_prefecture)=='鹿児島県') selected @endif>鹿児島県</option>
                                    <option value="沖縄県" @if(old('place_prefecture',$plans->place_prefecture)=='沖縄県') selected @endif>沖縄県</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="place_address" value="{{ old('place_address',$plans->place_address) }}" placeholder="※最大100文字まで">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">アクセス方法</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="place_access" value="{{ old('place_access',$plans->place_access) }}" placeholder="※最大120文字まで">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-3">
                                <label class="col-md-10 col-form-label text-md-left">緯度：<span class="lat1">{{$plans->place_latitude}}</span></label>
                                <input type="hidden" name="place_latitude" value="{{ old('place_latitude',$plans->place_latitude) }}">
                            </div>
                            <div class="col-md-3">
                                <label class="col-md-10 col-form-label text-md-left">経度：<span class="lng1">{{$plans->place_longitude}}</span></label>
                                <input type="hidden" name="place_longitude" value="{{ old('place_longitude',$plans->place_longitude) }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right" style="padding: 0 0 3px 0;">集合場所</label>
                            <label class="radio-inline">
                              <input class="ml-5" type="radio" name="meeting_point_flag" value="0" @if ($plans->meeting_point_flag == 0) checked @endif> <span> 体験場所と同じ場所を設定する</span>
                            </label>
                            <label class="checkbox-inline">
                              <input class="ml-5" type="radio" name="meeting_point_flag" value="1" @if ($plans->meeting_point_flag == 1) checked @endif> <span> 個別設定する</span>
                            </label>
                            <label class="checkbox-inline">
                              <input class="ml-5" type="radio" name="meeting_point_flag" value="2" @if ($plans->meeting_point_flag == 2) checked @endif> <span> 設定しない</span>
                            </label>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="meeting_point_name" value="{{ old('meeting_point_name',$plans->meeting_point_name) }}" placeholder="※最大120文字まで">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"> 郵便番号</label>
                            <div class="col-md-4">
                                <input type="text" class="form-control" name="meeting_point_postalcode" value="{{ old('meeting_point_postalcode',$plans->meeting_point_postalcode) }}" onKeyUp="AjaxZip3.zip2addr(this,'','meeting_point_prefecture','meeting_point_address');" placeholder="自動で住所検索します（ハイフンありなし可）">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"> 都道府県</label>
                            <div class="col-md-3">
                                <select class="form-control" name="meeting_point_prefecture">
                                    ...
                                    <option value="北海道" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='北海道') selected @endif>北海道</option>
                                    <option value="青森県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='青森県') selected @endif>青森県</option>
                                    <option value="岩手県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='岩手県') selected @endif>岩手県</option>
                                    <option value="宮城県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='宮城県') selected @endif>宮城県</option>
                                    <option value="秋田県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='秋田県') selected @endif>秋田県</option>
                                    <option value="山形県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='山形県') selected @endif>山形県</option>
                                    <option value="福島県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='福島県') selected @endif>福島県</option>
                                    <option value="茨城県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='茨城県') selected @endif>茨城県</option>
                                    <option value="栃木県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='栃木県') selected @endif>栃木県</option>
                                    <option value="群馬県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='群馬県') selected @endif>群馬県</option>
                                    <option value="埼玉県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='埼玉県') selected @endif>埼玉県</option>
                                    <option value="千葉県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='千葉県') selected @endif>千葉県</option>
                                    <option value="東京都" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='東京都') selected @endif>東京都</option>
                                    <option value="神奈川県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='神奈川県') selected @endif>神奈川県</option>
                                    <option value="新潟県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='新潟県') selected @endif>新潟県</option>
                                    <option value="富山県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='富山県') selected @endif>富山県</option>
                                    <option value="石川県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='石川県') selected @endif>石川県</option>
                                    <option value="福井県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='福井県') selected @endif>福井県</option>
                                    <option value="山梨県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='山梨県') selected @endif>山梨県</option>
                                    <option value="長野県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='長野県') selected @endif>長野県</option>
                                    <option value="岐阜県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='岐阜県') selected @endif>岐阜県</option>
                                    <option value="静岡県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='静岡県') selected @endif>静岡県</option>
                                    <option value="愛知県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='愛知県') selected @endif>愛知県</option>
                                    <option value="三重県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='三重県') selected @endif>三重県</option>
                                    <option value="滋賀県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='滋賀県') selected @endif>滋賀県</option>
                                    <option value="京都府" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='京都府') selected @endif>京都府</option>
                                    <option value="大阪府" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='大阪府') selected @endif>大阪府</option>
                                    <option value="兵庫県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='兵庫県') selected @endif>兵庫県</option>
                                    <option value="奈良県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='奈良県') selected @endif>奈良県</option>
                                    <option value="和歌山県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='和歌山県') selected @endif>和歌山県</option>
                                    <option value="鳥取県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='鳥取県') selected @endif>鳥取県</option>
                                    <option value="島根県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='島根県') selected @endif>島根県</option>
                                    <option value="岡山県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='岡山県') selected @endif>岡山県</option>
                                    <option value="広島県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='広島県') selected @endif>広島県</option>
                                    <option value="山口県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='山口県') selected @endif>山口県</option>
                                    <option value="徳島県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='徳島県') selected @endif>徳島県</option>
                                    <option value="香川県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='香川県') selected @endif>香川県</option>
                                    <option value="愛媛県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='愛媛県') selected @endif>愛媛県</option>
                                    <option value="高知県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='高知県') selected @endif>高知県</option>
                                    <option value="福岡県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='福岡県') selected @endif>福岡県</option>
                                    <option value="佐賀県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='佐賀県') selected @endif>佐賀県</option>
                                    <option value="長崎県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='長崎県') selected @endif>長崎県</option>
                                    <option value="熊本県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='熊本県') selected @endif>熊本県</option>
                                    <option value="大分県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='大分県') selected @endif>大分県</option>
                                    <option value="宮崎県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='宮崎県') selected @endif>宮崎県</option>
                                    <option value="鹿児島県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='鹿児島県') selected @endif>鹿児島県</option>
                                    <option value="沖縄県" @if(old('meeting_point_prefecture',$plans->meeting_point_prefecture)=='沖縄県') selected @endif>沖縄県</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">住所</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="meeting_point_address" value="{{ old('meeting_point_address',$plans->meeting_point_address) }}" placeholder="※最大100文字まで">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">アクセス方法</label>
                            <div class="col-md-6">
                                <input id="" type="text" class="form-control" name="meeting_point_access" value="{{ old('meeting_point_access',$plans->meeting_point_access) }}" placeholder="※最大120文字まで">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"><span class="badge badge-danger">必須</span> 地図設定</label>
                            ...
                            <div class="col-md-3">
                                <label class="col-md-10 col-form-label text-md-left">緯度：<span class="lat2">{{$plans->meeting_point_latitude}}</span></label>
                                <input type="hidden" name="meeting_point_latitude" value="{{ old('meeting_point_latitude',$plans->meeting_point_latitude) }}">
                            </div>
                            <div class="col-md-3">
                                <label class="col-md-10 col-form-label text-md-left">経度：<span class="lng2">{{$plans->meeting_point_longitude}}</span></label>
                                <input type="hidden" name="meeting_point_longitude" value="{{ old('meeting_point_longitude',$plans->meeting_point_longitude) }}">
                            </div>
                        </div>
                        </div>
                        <div class="form-group row mt-5 bg-dark">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"></label>
                            <div class="col-md-6">
                                <textarea id="" type="textarea" class="form-control" name="question_content" rows="10" placeholder="※最大1200文字まで">{{ old('question_content',$plans->question_content) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right"></label>
                            <div class="col-md-6">
                                <textarea id="" type="textarea" class="form-control" name="caution_content" rows="10" placeholder="※最大5000文字まで">{{ old('caution_content',$plans->caution_content) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-5 bg-dark">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <textarea id="" type="textarea" class="form-control" name="item" rows="4" placeholder="※最大1000文字まで">{{ old('item',$plans->item) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-2 col-form-label text-md-right">服装</label>
                            <div class="col-md-8">
                                <textarea id="" type="textarea" class="form-control" name="wear" rows="4" placeholder="※最大1000文字まで">{{ old('wear',$plans->wear) }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row mt-5 bg-dark">
...
-->
                                <input id="post-button" type="submit" class="btn btn-primary submit" data-action="/client/plans/update/{{ $plans->id }}" value="変更する">
				<!--
				<input id="tmp-button" type="submit" class="btn btn-warning submit" data-action="/client/plans/update-tmp/{{ $plans->id }}" value="下書き保存">
				-->
                                <a href="/client/plans" class="btn btn-secondary">戻る</a>
                            </div>
                        </div>
                    </form>
                </div>
...
$('div[name="add-price"]').click(function(e) {
    ...
    $(".after-price-section-" + (val)).load('/html/plan-price.php', function() {
        ...
        $('input[name="price_week_flag"]').attr('name', 'price_week_flag' + (val + 1));
        $('input[name="price_monday"]').attr('name', 'price_monday' + (val + 1));
...
$('#post-button').on('click',function(){
    $.extend( $.validator.messages, {
        require_from_group: $.validator.format( '最低{0} つはチェック必須' )
    });
    ...
    var validator = $("#form1").validate({
       rules : {
           ...
           spot: {
               require_from_group: [1, '.payment-method-group']
           },
           cvs: {
               require_from_group: [1, '.payment-method-group']
           },
...
*/
    ...
    // 料金区分の追加フォーム
    // 割引前料金のフォームへバリデーション追加
    if ($('input[name="is_discount"]:checked').val() == 1) {
        $('.before-price-group').each(function() {
            $(this).rules("add", 
                {
                    required: true,
                    messages: {
    ...
    for (var i = 1; i <= 6; i++) {
	//曜日別オン
        if ($('input[name="price_week_flag' + i + '"]').prop("checked")) {
	    $('input[name="price_price' + i +'"]').rules("remove");
            $('input[name="price_monday' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
            ...
            $('input[name="price_tuesday' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
            ...
            $('input[name="price_wednesday' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
            ...
            $('input[name="price_thursday' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
            ...
            $('input[name="price_friday' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
            ...
            $('input[name="price_saturday' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
            ...
            $('input[name="price_sunday' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
            ...
            $('input[name="price_holiday' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
            ...
            $('input[name="price_price' + i +'"]').rules("add", 
                {
                    required: true,
                    messages: {
                        required: "このフィールドは必須です。",
    ...
    // 集合時間追加フォーム
    if ($('input[name="meeting_point_flag"]:checked').val() == 1) {
        $('input[name="meeting_point_name"]').rules("add", 
            {
                required: true,
                messages: {
                    required: "このフィールドは必須です。",
        ...
        $('input[name="meeting_point_address"]').rules("add", 
            {
	        maxlength: 100,
                messages: {
                    maxlength: "最大100文字以内で入力してください。",
                }
            });
        $('input[name="meeting_point_access"]').rules("add", 
            {
	        maxlength: 120,
                messages: {
                    maxlength: "最大120文字以内で入力してください。",
                }
            });
        $('input[name="meeting_point_latitude"]').rules("add", 
            {
                required: true,
                messages: {
                    required: "このフィールドは必須です。",
        ...
        $('input[name="meeting_point_longitude"]').rules("add", 
            {
                required: true,
                messages: {
                    required: "このフィールドは必須です。",
